...
public class Utils {
    ...
    /**
     * Return true if currentUserEmail equals to journalList.owner()
     * Return false otherwise
     */
    public static boolean checkIfOwner(JournalList journalList, String currentUserEmail) {
        return (journalList.getOwner() != null &&
                journalList.getOwner().equals(currentUserEmail));
    }
