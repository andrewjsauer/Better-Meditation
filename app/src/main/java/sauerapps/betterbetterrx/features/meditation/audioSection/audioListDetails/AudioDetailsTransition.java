...
public class AudioDetailsTransition extends TransitionSet {
    public AudioDetailsTransition() {
        init();
    }
     ...
     */
    public AudioDetailsTransition(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
