package sauerapps.sauermeditation.features.meditation.audioSection;
...
import sauerapps.sauermeditation.app.events.EventAudioOnComplete;
import sauerapps.sauermeditation.app.events.EventAudioPaused;
import sauerapps.sauermeditation.app.events.EventAudioSyncFinish;
...
import sauerapps.sauermeditation.utils.AudioListUtil;
...
public class AudioActivity extends BaseActivity {
    ...
    private void exitAudioDetails() {
        ...
        if (mTimeElapsed >= 10000) {
            ...
            saveBundle.putString(FirebaseAnalytics.Param.ITEM_CATEGORY, "Save dialog prompted");
            mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, saveBundle);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Bundle savePositiveBundle = new Bundle();
                            savePositiveBundle.putString(FirebaseAnalytics.Param.ITEM_CATEGORY, "Saving session");
                            mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, savePositiveBundle);
                    ...
                    .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Bundle cancelSaveBundle = new Bundle();
                            cancelSaveBundle.putString(FirebaseAnalytics.Param.ITEM_CATEGORY, "Cancelling our save session");
                            mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, cancelSaveBundle);
